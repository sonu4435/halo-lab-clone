...
import ArrowButtonAnimation from "./Animations/ArrowBtnReviw";
...
const PartnershipBox = ({
  ...
  return <div className="boxContainer group rounded-2xl flex w-full h-[280px] relative z-20 cursor-pointer bg-slate-100" onMouseEnter={onHover} onMouseLeave={onLeave}>
      <div className="w-auto p-8 flex items-start justify-start h-full">
        <div className="box h-14 w-14 rounded-full">
          <img src={img} alt={`${title} image`} />
        </div>
        <ArrowButtonAnimation dir="up" isHovered={isHovered} />
      </div>
